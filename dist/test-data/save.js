...
const core = __importStar$1(require("@actions/core"));
const path = __importStar$1(require("path"));
const utils = __importStar$1(require("./internal/cacheUtils"));
const cacheHttpClient = __importStar$1(require("./internal/cacheHttpClient"));
const cacheTwirpClient = __importStar$1(require("./internal/shared/cacheTwirpClient"));
...
const key = `d2l-test-${ undefined.runId }-${ undefined.runNumber }`;
const restoreKeys = [
    `d2l-test-${ undefined.runId }-`
];
await undefined(paths, key, restoreKeys);
